          ...
          children: <Widget>[
            ...
            /*AnimatedPositioned(
              ...
              //height: selected ? 50.0 : 200.0,
                top: widthHeigthGet(widget.chessBoardController.game.history.isNotEmpty ? widget.chessBoardController.game.history.last.move.from : 0)[0] ?? 0.0,
                left: widthHeigthGet(widget.chessBoardController.game.history.isNotEmpty ? widget.chessBoardController.game.history.last.move.from : 0)[1] ?? 0.0,
                duration: const Duration(seconds: 10),
                curve: Curves.fastOutSlowIn,
                child: SizedBox( width: 10, height:10, child: Container(color: Colors.red))
              //child:  WhitePawn(size: MediaQuery.of(context).size.width/8)),
            ),*/
          ],
        ),
      ),
