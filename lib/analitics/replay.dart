...
class concreteGamePage extends StatefulWidget {
  const concreteGamePage({required this.game});
  ...
  @override
  State<concreteGamePage> createState() => _concreteGamePageState();
}

class _concreteGamePageState extends State<concreteGamePage> {
